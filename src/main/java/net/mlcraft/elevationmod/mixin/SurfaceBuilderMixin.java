...
import net.mlcraft.elevationmod.accessor.*;
...
public abstract class SurfaceBuilderMixin implements AMISurfaceBuilderAccessor {
    ...
    @Override
    public void buildSurface(NoiseConfig noiseConfig, BiomeAccess biomeAccess, Registry<Biome> biomeRegistry, boolean useLegacyRandom, HeightContext heightContext, final Chunk chunk, ChunkNoiseSampler chunkNoiseSampler, MaterialRules.MaterialRule materialRule, RegistryEntry<MLCraftMapInfo> ami) {
        ...
        ((MapInfoAccessor)(Object) materialRuleContext).mlcraft_setAMI(ami);
